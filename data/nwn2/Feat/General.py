...
def register(protos):
    register_feat(protos, 'General', 'Dodge',
        apply = lambda source, unit, feat, params: unit.calc.addSource('ArmorClass.Dodge', name=source, calcInt=1),
        unapply = lambda source, unit, feat, params: unit.calc.removeSource('ArmorClass.Dodge', source),
    ...
    register_feat(protos, 'Toughness', 'Toughness',
        apply = lambda source, unit, feat, params: unit.calc.addSource('HitPoint', name=source, calcInt=lambda caster,target: unit.getClassLevel()),
        unapply = lambda source, unit, feat, params: unit.calc.removeSource('HitPoint', source),
    ...
    register_feat(protos, 'Toughness', 'Epic Toughness',
        nameMember = 'Epic',
        apply = lambda source, unit, feat, params: unit.calc.addSource('HitPoint', name=source, calcInt=lambda caster,target: 30),
        unapply = lambda source, unit, feat, params: unit.calc.removeSource('HitPoint', source),
