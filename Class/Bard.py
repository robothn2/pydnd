...
proto = {
    ...
    'ReflexPerLevel': 0.5,
    'WillPerLevel': 0.5,
    'WeaponProficiency': ['Simple', 'Longsword', 'Rapier', 'Shortsword', 'Shortbow'],
    'ArmorProficiency': ['Light', 'Shield'],
    'SpellType': 'Arcane',
    'SkillPoints': 6,
    'ClassSkills': ['Appraise', 'Bluff', 'Concentration', 'CraftAlchemy', 'CraftArmor', 'CraftTrap', 'CraftWeapon', 'Diplomacy', 'Hide', 'Listen', 'Lore', 'MoveSilently', 'Parry', 'Perform', 'SleightOfHand', 'Spellcraft', 'Taunt', 'Tumble', 'UseMagicDevice'],
    'BonusFeats': (
